                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/destinations" className="text-gray-400 hover:text-white">Destinasi</Link></li>
                            <li><Link href="/services" className="text-gray-400 hover:text-white">Layanan</Link></li>
                            <li><Link href="/tours" className="text-gray-400 hover:text-white">Paket Tur</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/services/accommodation" className="text-gray-400 hover:text-white">Akomodasi</Link></li>
                            <li><Link href="/services/transportation" className="text-gray-400 hover:text-white">Transportasi</Link></li>
                            <li><Link href="/services/diving" className="text-gray-400 hover:text-white">Diving & Snorkeling</Link></li>
                            <li><Link href="/services/culinary" className="text-gray-400 hover:text-white">Kuliner</Link></li>
                            <li><Link href="/services/guide" className="text-gray-400 hover:text-white">Pemandu Wisata</Link></li>
                        </ul>
                    </div>
